...
<div id="thing" class="text-white text-6xl h-20 overflow-hidden">
    <span>figgyc's Bracketcounter</span>
...
<div id="legal" class="float-left h-[3%] bg-gray-800 p-1.5">
    <a href="#" onclick="document.querySelector('#privacypolicy').style.display ='block'">Legal Notices</a>
    <a href="https://youtube.com">
        <img src="./developed-with-youtube.svg" class="h-8"/>
    </a>
</div>

<div id="privacypolicy" class="z-[9999] fixed overflow-y-scroll overflow-x-scroll top-[0] left-[0] right-[0] bottom-[0] m-auto w-11/12 h-11/12 shadow-2xl bg-gray-900 p-2 text-gray-300 block">
    <h1>Legal stuff</h1>
    Before you use this website please read and agree to the following:<br>
    <h3>Disclaimer</h3>
    <ul>
    ...
    <ul>
        ...
        <li>By using this website, you agree to be bound by the YouTube Terms of Service avaliable at <a href="https://www.youtube.com/t/terms">https://www.youtube.com/t/terms</a>.</li>
    </ul>
    <h3>Privacy Policy</h3>
    <ul>
        <li>This website uses YouTube API Services and your usage may be subject to the Google Privacy Policy avaliable at <a href="http://www.google.com/policies/privacy">http://www.google.com/policies/privacy</a>.</li>
        ...
        <li>This website collects the following data:
            <ul>
                ...
                <li>Total vote counts recieved for each letter are shared publicly on this website however there is no way to connect you personally to which letter you may have voted for through this website.</li>
