...
<svelte:head>
    ...
    <script
        async
        src="https://www.googletagmanager.com/gtag/js?id=G-9NR4C4M5T0"
    ></script>
    <script>
...
{#if acceptedTerms}
    {#if !accessibility.noBackground}
        <img
            class="w-full absolute -top-[50px]"
    ...
    <main class="flex flex-col bg-black text-white h-full">
        ...
        <header
            class="flex items-center justify-between text-neutral-50 min-h-[66px] max-h-[100px] grow px-5 z-10"
        >
            <!--                <span class="title p-2">[bc]</span>-->
            <!--                TODO: Remove max-md:hidden once tpot 10 releases-->
            <span
                class="text-white/50 drop-shadow-lg text-5xl max-md:text-3xl md:p-2 max-md:hidden"
                >[bc]</span
            >
...
{:else}
    ...
    <div class="flex justify-center">
        <div
            ...
            class="w-full h-full mx-20 p-5 text-xl leading-normal z-10 shadow-2xl bg-gray-900 text-gray-300"
        >
            <p class="font-bold text-4xl text-center">
                Before you use this website please read and agree to the
                following:
            </p>
            <h3>Disclaimer</h3>
            <ul>
                <li style="color: yellow">
                    <strong>Spoiler warning!</strong> This website contains unofficial
                    predictions of TPOT results so do not click through if you do
                    not want to find out who is eliminated.
                </li>
                <li class="text-orange-500">
                    <strong>Notice</strong> This is a modified version of
                    <a href="https://bracket.figgyc.uk/live/"
                        >figgyc's bracketcounter</a
                    >!
                </li>
                <li>
                    This website counts votes with comment data sourced from
                    YouTube's Data API however the counting is done
                    independently from YouTube and is not endorsed by YouTube or
                    anyone else and no guarantee is made towards its accuracy or
                    validity.
                </li>
            </ul>
            <h3>Terms of Use</h3>
            <ul>
                <li>
                    By clicking Accept at the bottom of this page, you agree to
                    this Terms of Use and the Privacy Policy.
                </li>
                <li>
                    By using this website, you agree to be bound by the YouTube
                    Terms of Service available at <a
            ...
            <ul>
                <li>
                    This website uses YouTube API Services and your usage may be
                    subject to the Google Privacy Policy available at <a
                        href="https://www.google.com/policies/privacy"
                        >https://www.google.com/policies/privacy</a
                    >.
                </li>
                <li>
                    The purpose of this website is to read comments from a
                    YouTube video, principally from the video series <a
                        href="https://www.youtube.com/playlist?list=PL24C8378F296DB656"
                        >Battle for Dream Island</a
                    >, and to provide an estimate of the amount of users who
                    indicate that they like or dislike characters for the
                    purposes of entertainment and convenience by reducing the
                    need to manually count comments.
                </li>
                <li>
                    This website collects the following data:
                    <ul>
                        <li>
                            Comment data is retrieved from YouTube, consisting
                            of user ID, comment ID, time the comment was last
                            updated, and comment text content, for the purposes
                            of reading "votes", character sequences typically in
                            the form of a letter between two square brackets,
                            and counting the votes received for a given letter.
                            Your full comment text is not stored.
                        </li>
                        <li>
                            Your user ID and comment ID are stored for the
                            purpose of only counting one vote per user. Your
                            user ID and comment ID are not shared.
                        </li>
                        <li>
                            The time your comment was last updated is stored for
                            the purpose of not counting votes published after
                            the period in which votes are counted, typically 48
                            hours after the video is uploaded. This is not
                            shared.
                        </li>
                        <li>
                            Total vote counts received for each letter are
                            shared publicly on this website however there is no
                            way to connect you personally to which letter you
                            may have voted for through this website.
                        </li>
                        <li>
                            All data will be deleted shortly after the period in
                            which votes are counted following a video's release,
                            no longer than 28 days after collection.
                        </li>
                    </ul>
                </li>
                <li>
                    I reserve the right to recollect data temporarily after the
                    vote period finishes for the purpose of providing the
                    service to YouTube for audit purposes.
                </li>
                <li>
                    Although the YouTube Terms of Service designate your
                    comment(s) as Content and provide other users with access to
                    them, you may request the website not count comments
                    connected to your YouTube channel by messaging me on discord
                    (@zelo101), including a link to your YouTube channel. This
                    request will be respected as soon as possible. Please note
                    that this request does not affect your comments on YouTube
                    and other parties are still able to collect that data. Of
                    course if you wish that nobody can read your comments, then
                    you should use a YouTube Application to delete the comment.
                </li>
                <li>
                    This website only stores two pieces of data on your device
                    using localStorage technology (basically, cookies) which is
                    used to track whether or not you have accepted this legal
                    notice, and to store your accessibility settings. This data
                    is not transmitted to my server and is only kept on this
                    device to ensure you have read the notice. If you do not
                    wish for this website to store data on this device then
                    decline the notice.
                </li>
            </ul>
            <div class="flex justify-center">
